...
import {composeResolvers} from "../../composable";
...
export const userResolvers = {
    ...
    Query: {
        users: composeResolvers(verifyTokenResolver, authResolver)((parent, {first = 10, offset = 0}, {db} : {db : DBConnection}, info: GraphQLResolveInfo) => {
